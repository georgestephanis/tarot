...
"use strict";var e=s(require("@babel/runtime-corejs2/helpers/classCallCheck")),t=s(require("@babel/runtime-corejs2/helpers/createClass")),r=s(require("@babel/runtime-corejs2/helpers/possibleConstructorReturn")),a=s(require("@babel/runtime-corejs2/helpers/getPrototypeOf")),n=s(require("@babel/runtime-corejs2/helpers/inherits"));function s(e){return e&&e.__esModule?e:{default:e}}!function(s,i,o){var c=s.element.createElement,d=s.i18n.__;var l=function(s){function o(){return(0,e.default)(this,o),(0,r.default)(this,(0,a.default)(o).apply(this,arguments))}return(0,n.default)(o,s),(0,t.default)(o,[{key:"render",value:function(){var e=this.props.id?this.props.id:null,t=i[e]?i[e]:null,r=this.props.classes||"";return c("figure",{key:"tarot/card/"+e},[c("div",{key:"tarot/card/"+e+"/div",className:"tarot-card "+r+(e?"":" empty")},[!!t&&c("img",{key:"tarot/card/"+e+"/image",className:"card-art",src:t.image_url,width:150,alt:t.unicode})]),c("figcaption",{key:"tarot/card/"+e+"/caption"},[!!e&&t.label+(-1!==r.indexOf("inverted")?" "+d("(Inverted)","tarot"):""),!e&&d("Choose a card…","tarot")])])}}]),o}(s.element.Component);s.blocks.registerBlockType("tarot/spread",{title:d("Tarot Spread","tarot"),icon:"admin-page",category:"widgets",supportHTML:!1,attributes:{cards:{type:"object",default:null}},edit:function(e){var t=null;return e.attributes.cards&&(t=e.attributes.cards),[!!t&&c("div",{key:"tarot-spread",className:e.className+" tarot-spread three-card"},o.map(t,function(e,t){return c(l,{key:"tarot/spread/"+t,classes:e.inverted?"inverted":"",id:t})})),!t&&c(s.components.Placeholder,{key:"tarot/spread/generate",label:d("Generate a Tarot Spread…","tarot"),icon:"admin-page"},[c(s.components.Button,{key:"tarot/spread/generate/button",isPrimary:!0,isLarge:!0,onClick:function(){var r,a,n;r=3,a=o.shuffle(o.toArray(i)),n=o.first(a,r),o.each(n,function(e,t){n[t].inverted=Math.random()>.5}),t=n;var s={};o.each(t,function(e){s[e.id]={inverted:e.inverted}}),e.setAttributes({cards:s})}},d("Three-Card Spread","tarot"))])]},save:function(e){var t=null;return e.attributes.cards&&(t=e.attributes.cards),c("ol",{className:"tarot-spread"},!!t&&o.map(t,function(e,t){return c("li",{key:"tarot/card/"+t},i[t].label+(e.inverted?" "+d("(Inverted)","tarot"):""))}))}})}(window.wp,tarotData.deck,_);
