...
"use strict";var e=n(require("@babel/runtime-corejs2/helpers/classCallCheck")),t=n(require("@babel/runtime-corejs2/helpers/createClass")),r=n(require("@babel/runtime-corejs2/helpers/possibleConstructorReturn")),a=n(require("@babel/runtime-corejs2/helpers/getPrototypeOf")),l=n(require("@babel/runtime-corejs2/helpers/inherits"));function n(e){return e&&e.__esModule?e:{default:e}}var c=wp.element,s=c.Component,i=c.Fragment,o=c.createElement,u=wp.editor.InspectorControls,d=wp.components,m=d.Placeholder,p=d.Button,h=d.PanelBody,f=wp.blocks,b=f.registerBlockType,v=f.getBlockType,E=f.createBlock,R=wp.i18n.__;!function(n,c,o){var d=React.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24"},React.createElement("path",{fill:"none",d:"M0 0h24v24H0V0z"}),React.createElement("path",{d:"M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm7.48 7.16l-5.01-.43-2-4.71c3.21.19 5.91 2.27 7.01 5.14zm-5.07 6.26L12 13.98l-2.39 1.44.63-2.72-2.11-1.83 2.78-.24L12 8.06l1.09 2.56 2.78.24-2.11 1.83.64 2.73zm-2.86-11.4l-2 4.72-5.02.43c1.1-2.88 3.8-4.97 7.02-5.15zM4 12c0-.64.08-1.26.23-1.86l3.79 3.28-1.11 4.75C5.13 16.7 4 14.48 4 12zm3.84 6.82L12 16.31l4.16 2.5c-1.22.75-2.64 1.19-4.17 1.19-1.52 0-2.94-.44-4.15-1.18zm9.25-.65l-1.11-4.75 3.79-3.28c.14.59.23 1.22.23 1.86 0 2.48-1.14 4.7-2.91 6.17z"}));var f=function(n){function s(){return(0,e.default)(this,s),(0,r.default)(this,(0,a.default)(s).apply(this,arguments))}return(0,l.default)(s,n),(0,t.default)(s,[{key:"render",value:function(){var e=this.props.id?this.props.id:null,t=c[e]?c[e]:null,r=this.props.classes||"";return React.createElement("figure",null,React.createElement(i,null,React.createElement("div",{className:"tarot-card "+r+(e?"":" empty")},!!t&&React.createElement("img",{className:"card-art",src:t.image_url,width:"150",alt:t.unicode})),React.createElement("figcaption",null,React.createElement(i,null,!!e&&t.label+(-1!==r.indexOf("inverted")?" "+R("(Inverted)","tarot"):""),!e&&R("Choose a card…","tarot")))))}}]),s}(s);b("tarot/spread",{title:R("Tarot Spread","tarot"),icon:d,category:"widgets",supports:{html:!1},attributes:{cards:{type:"object",default:null}},edit:function(e){var t=null;return e.attributes.cards&&(t=e.attributes.cards),React.createElement(i,null,t?React.createElement("div",{key:"tarot-spread",className:e.className+" tarot-spread three-card"},o.map(t,function(e,t){return React.createElement(f,{key:"tarot/spread/"+t,classes:e.inverted?"inverted":"",id:t})})):React.createElement(m,{key:"tarot/spread/generate",label:R("Generate a Tarot Spread…","tarot"),icon:d},React.createElement(p,{key:"tarot/spread/generate/button",isPrimary:!0,isLarge:!0,onClick:function(){var r,a,l;r=3,a=o.shuffle(o.toArray(c)),l=o.first(a,r),o.each(l,function(e,t){l[t].inverted=Math.random()>.5}),t=l;var n={};o.each(t,function(e){n[e.id]={inverted:e.inverted}}),e.setAttributes({cards:n})}},R("Three-Card Spread","tarot"))),React.createElement(u,null,React.createElement(h,{title:R("Tarot Settings","tarot")},React.createElement(p,{isPrimary:!!e.attributes.cards,disabled:!e.attributes.cards,isLarge:!0,onClick:function(){e.setAttributes({cards:null})}},R("Clear Spread","tarot")))))},save:function(e){var t=null;return e.attributes.cards&&(t=e.attributes.cards),React.createElement("ol",{className:"tarot-spread"},!!t&&o.map(t,function(e,t){return React.createElement("li",{key:"tarot/card/"+t},c[t].label+(e.inverted?" "+R("(Inverted)","tarot"):""))}))}})}(window.wp,tarotData.deck,_);
